  ...
  const values = [
    {
      icon: Heart,
      title: "Confiance",
      description: "Un accompagnement sérieux, des contrats signés à l'agence pour chaque dossier. Transparence totale sur chaque étape de votre projet.",
    },
    {
      icon: Users,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div>
            ...
            {/* Mission */}
            <div className="bg-gradient-to-r from-[#00AEEF]/10 to-blue-600/10 rounded-2xl p-6 border border-[#00AEEF]/20 mb-6">
          ...
          <div className="relative">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl bg-slate-900 p-8">
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div key={i} className="bg-white/5 border border-white/10 rounded-2xl p-4 hover:bg-white/10 transition-all">
                    ...
                    <div className="text-[#00AEEF] font-bold text-xs">Réussite {d.rate}</div>
                  </div>
                ))}
              </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {values.map((value, index) => (
              <div key={index} className="text-center group hover:bg-gradient-to-br hover:from-[#00AEEF]/5 hover:to-blue-600/5 rounded-3xl p-8 transition-all duration-300 border border-transparent hover:border-[#00AEEF]/10">
