        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-3 mt-6">
              <a
                ...
                className="w-10 h-10 bg-slate-800 rounded-xl flex items-center justify-center hover:bg-[#00AEEF] transition-colors duration-300"
                aria-label="Facebook"
              >
                <Facebook size={18} />
              </a>
          ...
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-3 bg-[#25D366] text-white font-bold px-5 py-3.5 rounded-2xl hover:bg-[#1ebd5a] transition-all transform hover:scale-[1.02] shadow-lg shadow-green-600/20 w-full justify-center text-sm"
            >
