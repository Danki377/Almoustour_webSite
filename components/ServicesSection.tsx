  ...
  return (
    <section id="services" className="py-24 bg-gradient-to-br from-slate-50 to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-16">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br ${service.color} rounded-2xl mb-6 transform group-hover:scale-110 transition-transform duration-300`}>
              ...
              <button
                ...
                className="mt-auto w-full flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1ebd5a] text-white font-bold py-3.5 rounded-2xl transition-all duration-300 transform hover:scale-[1.02] shadow-md shadow-green-500/20"
              >
        ...
        <div className="bg-white rounded-3xl p-8 shadow-lg border border-gray-100 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {additionalServices.map((service, index) => (
              <div key={index} className="text-center group hover:bg-gray-50 rounded-2xl p-5 transition-all duration-300">
        ...
        {/* Bottom CTA */}
        <div className="bg-slate-950 rounded-3xl p-10 text-white text-center shadow-2xl">
          ...
          <button
            ...
            className="inline-flex items-center gap-3 bg-[#25D366] text-white px-10 py-4 rounded-full font-bold hover:bg-[#1ebd5a] transition-all duration-300 transform hover:scale-105 shadow-xl shadow-green-600/30 text-lg"
          >
