    ...
    <section id="contact" className="py-24 bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <div className="w-20 h-1.5 bg-gradient-to-r from-[#00AEEF] to-blue-600 mx-auto mt-8 rounded-lg" />
        </div>

        <div className="max-w-5xl mx-auto">
          {/* WhatsApp CTA — Primary */}
          <div className="bg-slate-950 rounded-2xl p-10 md:p-14 text-white text-center mb-8 relative overflow-hidden shadow-2xl">
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_rgba(37,211,102,0.1)_0%,_transparent_60%)]" />
            <div className="relative z-10">
              <div className="w-20 h-20 bg-[#25D366] rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-green-500/30">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  ...
                  className="inline-flex items-center justify-center gap-3 bg-[#25D366] text-white font-bold px-10 py-4 rounded-xl hover:bg-[#1ebd5a] transition-all shadow-xl shadow-green-600/30 transform hover:scale-105 text-lg"
                >
                  Études à l&#39;étranger
                </button>
                <button
                  onClick={() => openWhatsApp("Bonjour Al-Moustour, je souhaite réserver un billet d'avion. Pouvez-vous m'aider ?")}
                  className="inline-flex items-center justify-center gap-3 bg-white/10 border border-white/20 text-white font-bold px-10 py-4 rounded-xl hover:bg-white/20 transition-all transform hover:scale-105 text-lg"
                >
                  Billetterie d&#39;avion
                </button>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            ...
            <div className="flex flex-col gap-5">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 flex-grow">
